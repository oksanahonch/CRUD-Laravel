...
<body>
    ...
    <div class="d-flex flex-column justify-content-start min-vh-100">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbar-collapse">
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-md-0">
                        ...
                        <li class="nav-item">
                            <a href="{{ route ('department.index') }}" class="nav-link active" aria-current="page">
                                {{ __('Department') }}
                            </a>
                        </li>
      ...
      <div class="container-md py-3 content">
        ...
        <a class="btn btn-outline-primary m-3" href="{{ route('department.create') }}" role="button">Создать новое</a>
                      ...
                      <td>
                        <div class="container>">
                           <div class="d-flex flex-row justify-content-evenly">
                               ...
                               <a href="{{ route('department.edit', $department) }}" type="button" class="btn btn-outline-success">
                                Редактировать
                              </a>
                              <form role="form" method="post" action="{{ route('department.delete', $department) }}">
                                 @method('DELETE')
                                 @csrf
                                 <div>
