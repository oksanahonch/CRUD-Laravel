...
<body>
    ...
    <div class="d-flex flex-column justify-content-start min-vh-100">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbar-collapse">
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-md-0">
                        ...
                        <li class="nav-item">
                            <a href="{{ route ('payment.index') }}" class="nav-link active" aria-current="page">
                                {{ __('Payment') }}
                            </a>
                        </li>
      ...
      <div class="container-md py-3 content">
        ...
        <a class="btn btn-outline-primary m-3" href="{{ route('payment.create') }}" role="button">Создать новую</a>
                      ...
                      <td>
                        <div class="container>">
                           <div class="d-flex flex-row justify-content-evenly">
                               ...
                               <a href="{{ route('payment.edit', $payment) }}" type="button" class="btn btn-outline-success">
                                Редактировать
                              </a>
                              <form role="form" method="post" action="{{ route('payment.delete', $payment) }}">
                                 @method('DELETE')
                                 @csrf
                                 <div>
